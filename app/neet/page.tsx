                ...
                <div className="max-w-7xl mx-auto px-4 text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-4xl mx-auto">
                        ...
                        <div className="p-12 rounded-[3.5rem] bg-black border-2 border-emerald-500/50 text-left scale-110 shadow-[0_0_100px_-20px_rgba(16,185,129,0.4)] z-10 flex flex-col">
                            ...
                            <ul className="space-y-6 mb-16 flex-1">
                                <li className="flex items-center text-sm font-black text-white"><Check className="w-5 h-5 mr-4 text-emerald-500" /> Everything in Standard</li>
                                <li className="flex items-center text-sm font-black text-white"><Sparkles className="w-5 h-5 mr-4 text-emerald-500 animate-pulse" /> AI-Powered Intelligence Insights</li>
                                <li className="flex items-center text-sm font-black text-white"><Check className="w-5 h-5 mr-4 text-emerald-500" /> Personalized Test Analytics</li>
                                <li className="flex items-center text-sm font-black text-white"><Check className="w-5 h-5 mr-4 text-emerald-500" /> Achievement Milestones & Badges</li>
                            </ul>
